...
export const POST = async ({ request }) => {
    ...
    const feedbackSelecionado = await request.json()
    const formData = new FormData();
    formData.append("wstoken", WSTOKEN_MOODLE);
    formData.append("wsfunction", "mod_feedback_get_responses_analysis");
    formData.append("moodlewsrestformat", "json");
    formData.append("feedbackid", feedbackSelecionado.id);
